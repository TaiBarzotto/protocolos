...
from apps.trabalhar_protokolos.models import Ccr, StatusRetorno, StatusRetornoDetalhado, Processos_arquivar
...
@bp_protocolos.route('/edit_ccr', methods=['POST'])
@specs.validate(
    body=Request(Ccr),
    resp=Response(HTTP_200=StatusRetornoDetalhado, HTTP_400=StatusRetornoDetalhado)
)
...
@bp_protocolos.route('/edit_ccr_objetivo', methods=['POST'])
@specs.validate(
...
@bp_protocolos.route('/pergamun', methods=['POST'])
@specs.validate(
